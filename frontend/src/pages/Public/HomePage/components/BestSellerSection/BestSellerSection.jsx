        ...
        <div className="featured-grid">
          <article className="featured-card animate-on-scroll">
            ...
            <div className="product-image-container">
              <img
                src="/images/products/BIG-BREAKFAST-3-bs.jpg"
                alt="The Big Breakfast"
              />
            </div>
            <div className="product-info">
              <h3>The Big Breakfast</h3>
              <p>
                Our signature morning plate with farm-fresh eggs and artisanal
                toast.
              </p>
          ...
          >
            ...
            <div className="product-image-container">
              <img
                src="/images/products/Blueberry-Cheesecake-600x600-bs.jpg"
            ...
            <div className="product-info">
              ...
              <p>
                Creamy NY-style cheesecake topped with wild mountain
                blueberries.
              </p>
          ...
          >
            ...
            <div className="product-image-container">
              <img
                src="/images/products/ICED-WHITE-CHOCOLATE-MOCHA-bs.png"
            ...
            <div className="product-info">
              ...
              <p>
                Premium espresso swirled with velvet white chocolate over ice.
              </p>
